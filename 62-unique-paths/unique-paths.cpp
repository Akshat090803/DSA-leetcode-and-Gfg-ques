...
public:
    ...
    int uniquePaths(int m, int n) {
        // we dont take visited array as as there is no chances of coming back
        // to parent as we move only down and right not top and left i.e, form
        // where we come
