...
class Solution {
  public:
    ...
    Node* makeBST(int preorder[],int size ,int lower, int upper, int& ind) {
    ...
    Node* Bst(int pre[], int size) {
        ...
        int upper=INT_MAX;
        int lower=INT_MIN;
        Node*root=makeBST(pre,size,lower,upper,ind);
        return root;
    }
};
